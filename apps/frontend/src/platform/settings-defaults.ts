...
export function defaultAppSettings(): AppSettings {
  return {
    ...
    codeAnalysis: { enabled: true, autoScan: false, includeGitignore: true, includeNodalStudioIgnore: true, maxFileBytes: 2 * 1024 * 1024, editor: "systemDefault", allowUncommittedCodeForRemoteAi: false, allowSourceExcerptsForRemoteAi: false },
