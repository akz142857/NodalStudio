...
function platformMock(compareSnapshots: NodalStudioPlatform["compareSnapshots"]): NodalStudioPlatform {
  return {
    ...
    getProjectScanStatus: vi.fn(),
    listProjectScans: vi.fn(),
    getProjectGraph: vi.fn(),
    getDatabaseCodeUsage: vi.fn(),
    getChangeImpact: vi.fn(),
    openCodeLocation: vi.fn(),
    ...
    previewModelFallback: vi.fn(),
    testModelConnection: vi.fn(),
    previewAiProjectContext: vi.fn(),
    runAiProjectAnalysis: vi.fn(),
    listAiCandidates: vi.fn(),
    listAiUsageEvents: vi.fn(),
    reviewAiCandidate: vi.fn(),
